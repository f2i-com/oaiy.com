...
| `zipp-notices/` | committed: the Unicode notices the web-python bundle does not ship, and `SOURCE.json` naming the ZIPP release they were generated from (see its `README.md`) | installed beside `zipp-wasm-python/` |
